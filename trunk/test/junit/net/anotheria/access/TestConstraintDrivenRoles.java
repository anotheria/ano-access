...
public class TestConstraintDrivenRoles {
	...
	private static void setupRolesAndPermissions() throws AccessServiceException {
		...
		femaleToMaleWrite.addConstraint(new FemaleObjectConstraint(), new MaleSubjectConstraint(), new SubjectAttributeIsEqualToObjectAttributeConstraint(
				"locale"));
	...
	public void testGetNotCreatedPermissionCollection() {
		service.getPermissionCollection("temprr");
	}

	@Test
	public void testPremium2PremiumWrite() throws AccessServiceException {
	...
	@Test
	public void testPremium2BasicWrite() throws AccessServiceException {
	...
	@Test
	public void testPremiumFromPremiumRead() throws AccessServiceException {
	...
	@Test
	public void testPremiumFromBasicRead() throws AccessServiceException {
	...
	@Test
	public void testBasicMaleWrite() throws AccessServiceException {
	...
	@Test
	public void testBasicMaleRead() throws AccessServiceException {
	...
	// basic male isn't allowed to write to anyone
	@Test
	public void testBasicFemaleWrite() throws AccessServiceException {
